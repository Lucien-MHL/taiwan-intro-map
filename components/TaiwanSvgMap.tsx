...
const tw = map_data as unknown as Omit<TopoJSON.Topology, 'arcs'> & {
  arcs: [number, number][][]
}
  ...
  const draw = useCallback(
    (svg: d3.Selection<SVGSVGElement, unknown, null, undefined>) => {
      ...
      mapGroup
        ...
        .on(
          'click',
          (event: React.MouseEvent<SVGPathElement, MouseEvent>, d) => {
    ...
    [createD3Zoom, handleCityClick, handleReset, setLoading, setStage]
  )
